...
<p class="scrap-without-first-image"></p><div id="note-text"><p>Une liste permet de stocker des éléments que l'on peut rappeler à l'aide de leurs indices :<br/></p>
<p><i>liste = ['a', 'b', 'c']</i></p>
...
<p>On peut connaitre le nombre d'éléments dans une liste ou un dictionnaire avec la fonction len :</p>
