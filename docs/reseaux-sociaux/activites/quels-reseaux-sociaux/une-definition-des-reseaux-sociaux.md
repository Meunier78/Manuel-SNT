...
<ul><li>de créer un profil personnel ; <br/></li><li>d'établir des relations avec d'autres utilisateurs (amitié, relation, contact, abonnement…) ;<br/></li><li>de partager des informations/contenus et d'interagir avec ces utilisateurs. <br/></li></ul></div>
</div>
