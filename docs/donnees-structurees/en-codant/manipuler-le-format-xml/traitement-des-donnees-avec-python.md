...
<p class="scrap-without-first-image"></p><div id="note-text"><p>Nous allons travailler à partir du fichier "films.xml" qui comporte des informations sur quelques films et artistes. Notre démarche, limitée à une petite quantité de données, pourrait être utilisée sur des banques d'informations beaucoup plus conséquentes.  <br/></p>
