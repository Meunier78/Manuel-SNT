# Data center et consommation d'énergie - Questions
...
<p>c) En utilisant les fonctionnalités du tableur (formule) calculer en % (ligne 5) la part de la consommation électrique des data center par rapport à celle mondiale en 2026, 2030, 2034, 2038 et 2042 (cases jaunes). Qu'observez-vous ? Comment pouvez-vous expliquer cette évolution ?</p>
<p>d) D'après EDF, un réacteur nucléaire de 900 MW produit en moyenne chaque année 6 TWh, ce qui correspond à la consommation de 400 000 foyers environ. En 2022, la consommation mondiale des centres de données équivaut à combien de réacteurs nucléaires ? À la consommation électrique annuelle de combien d'habitants cela correspond-t-il ?</p>
<p>2. Les plateformes de streaming vidéo utilisent des data center pour stocker les films qu'elles proposent à leurs clients. Lorsque vous regardez chez vous en streaming sur votre TV une série HD de 1h00 , cela représente une consommation électrique d'environ 0,56 kWh. En France, 1 Kwh produit une empreinte carbone d'environ 100 g équivalent CO<sub>2</sub> ce qui correspond à une distance de 1 km parcourue par une voiture thermique.</p>
