...
<p class="scrap-without-first-image"></p><div id="note-text"><p><b>ipconfig</b><br/>Cette commande affiche les informations de configuration IP de votre ordinateur, tels que l'adresse IP, le masque de sous-réseau, la passerelle par défaut et les adresses MAC. Vous pouvez également utiliser les options "/release" et "/renew" pour libérer et renouveler une adresse IP auprès d'un serveur DHCP.</p>
