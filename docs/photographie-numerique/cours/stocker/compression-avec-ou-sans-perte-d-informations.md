...
<p class="scrap-without-first-image"></p><div id="note-text"><p>Les quantités d'information permettant de stocker une image sont de plus en plus importantes, parce que la définition des images (en pixels) grandit année après année.<br/></p>
