...
<p class="scrap-without-first-image"></p><div id="note-text"><h2><b>Exercice 1</b></h2><p><b>encode64(codein)</b> : dictionnaire qui permet de traduire un caractère en un code binaire sur six bits. Pour le caractère "r" ce sera '<span style=" background-color:#ffa900;display:inline-block;">101011</span>'.<br/></p>
