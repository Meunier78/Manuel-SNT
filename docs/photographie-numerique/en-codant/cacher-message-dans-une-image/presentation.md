...
<p class="scrap-without-first-image"></p><div id="note-text"><p>Bob souhaite envoyer un message secret à Alice. Il décide de cacher son message dans une image selon le principe de la stéganographie. Voici comment il s'y prend :</p>
