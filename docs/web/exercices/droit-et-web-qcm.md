...
<p>3. Qu'est-ce qu'une violation de droits d'auteur sur le web ?<br/></p>
<p>a) Le fait de télécharger des fichiers gratuitement.<br/>b) Le fait de copier et distribuer des contenus sans permission.<br/>c) Le fait d'utiliser des emojis sans autorisation.</p>
<p>4. Qu'est-ce qu'une licence logicielle ?</p>
<p>a) Un fichier contenant des images et des vidéos utilisées dans un site web.<br/>b) Un programme qui permet de créer des sites web.<br/>c) Un document qui donne le droit d'utiliser un logiciel. </p>
<p>5. Qu'est-ce qu'un cookie dans le contexte du web ?<br/></p>
<p>a) Un logiciel malveillant qui infecte les ordinateurs.<br/>b) Un fichier qui stocke des informations sur les utilisateurs d'un site web.<br/>c) Un terme utilisé pour décrire une connexion Internet lente.</p>
<p>6. Qu'est-ce qu'un phishing ?</p>
