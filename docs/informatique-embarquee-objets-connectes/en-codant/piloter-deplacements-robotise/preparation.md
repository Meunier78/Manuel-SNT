...
<p>L’objectif est de commander l’angle de rotation d’un servomoteur par le biais d’une interface homme-machine (IHM) comportant un curseur de réglage et un bouton poussoir d’envoi de la valeur réglée.</p>
